...
global $TYPO3_CONF_VARS;
		...
		if (!$this->aDataFromURL)	die('Parameter Error: Wrong ID - no data found with this ID');
		
		$this->damid 	= $this->aDataFromURL['damid'];
		$this->src 		= $this->aDataFromURL['src'];
		$this->target 	= $this->aDataFromURL['target'];
	...
	function main()	
		...
		*/
		...
		if((!is_file(PATH_site . $fileToDownloadDAM)) || 
			$filemd5DAM != $this->aDataFromURL['filemd5']) {
			/*
